...
public interface BookingService {
    ...
    List<BookingDtoOut> getBookingOwnerByStatus(Long userId, BookingState approved);

    List<BookingDtoOut> getBookingItemsByStatus(Long userId, BookingState approved);
